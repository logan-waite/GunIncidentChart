...
var $author$project$Main$StateIncidents = F3(
	function (state, rating, incidents) {
		return {incidents: incidents, rating: rating, state: state};
	});
...
var $author$project$Main$calculateIncidentsPerState = function (incidents) {
	var reducer = F2(
		function (incident, stateIncidents) {
			var _v0 = A2(
				$elm_community$list_extra$List$Extra$findIndex,
				function (stateIncident) {
					return _Utils_eq(incident.state, stateIncident.state);
				},
				stateIncidents);
			if (_v0.$ === 'Nothing') {
				return A2(
					$elm$core$List$cons,
					A3($author$project$Main$StateIncidents, incident.state, 0, 1),
					stateIncidents);
			} else {
				var index = _v0.a;
				return A3(
					...
					function (state) {
						return _Utils_update(
							state,
							{incidents: state.incidents + 1});
					},
					stateIncidents);
			}
		});
	return A3($elm$core$List$foldl, reducer, _List_Nil, incidents);
};
...
var $author$project$Main$updateStateGunRatings = F2(
	function (gunLaws, stateIncidents) {
		var updateState = function (gunLaw) {
			var _v0 = A2(
				$elm_community$list_extra$List$Extra$find,
				function (state) {
					return _Utils_eq(state.state, gunLaw.state);
				},
				stateIncidents);
			if (_v0.$ === 'Just') {
				var state = _v0.a;
				return _Utils_update(
					state,
					{rating: gunLaw.rating});
			} else {
				return A3($author$project$Main$StateIncidents, gunLaw.state, gunLaw.rating, 0);
			}
		};
		return A2($elm$core$List$map, updateState, gunLaws);
	});
var $author$project$Main$getStateData = F2(
	function (gunLawsRaw, incidentsRaw) {
		return A2(
			...
			A2(
				$author$project$Main$updateStateGunRatings,
				gunLawsRaw,
				$author$project$Main$calculateIncidentsPerState(incidentsRaw)));
	});
...
var $author$project$Main$InitFlags = F2(
	function (incidentsRaw, gunLawsRaw) {
		return {gunLawsRaw: gunLawsRaw, incidentsRaw: incidentsRaw};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Main$GunIncidentRaw = F6(
	function (id, date, state, cityOrCounty, killed, injured) {
		return {cityOrCounty: cityOrCounty, date: date, id: id, injured: injured, killed: killed, state: state};
	});
...
var $author$project$Main$posixDecoder = A2($elm$json$Json$Decode$map, $elm$time$Time$millisToPosix, $elm$json$Json$Decode$int);
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$gunIncidentsDecoder = $elm$json$Json$Decode$list(
	A7(
		$elm$json$Json$Decode$map6,
		$author$project$Main$GunIncidentRaw,
		A2($elm$json$Json$Decode$field, 'incidentId', $elm$json$Json$Decode$int),
		A2($elm$json$Json$Decode$field, 'incidentDate', $author$project$Main$posixDecoder),
		A2($elm$json$Json$Decode$field, 'state', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'cityOrCounty', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'killed', $elm$json$Json$Decode$int),
		A2($elm$json$Json$Decode$field, 'injured', $elm$json$Json$Decode$int)));
var $author$project$Main$GunLawRaw = F2(
	function (state, rating) {
		return {rating: rating, state: state};
	});
var $author$project$Main$gunLawsDecoder = $elm$json$Json$Decode$list(
	A3(
		$elm$json$Json$Decode$map2,
		$author$project$Main$GunLawRaw,
		A2($elm$json$Json$Decode$field, 'state', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'rating', $elm$json$Json$Decode$int)));
var $author$project$Main$initFlagsDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$InitFlags,
	A2($elm$json$Json$Decode$field, 'incidents', $author$project$Main$gunIncidentsDecoder),
	A2($elm$json$Json$Decode$field, 'gunLaws', $author$project$Main$gunLawsDecoder));
...
var $author$project$Main$init = function (flags) {
	var _v0 = A2(
		...
		{gunLawsRaw: _List_Nil, incidentsRaw: _List_Nil},
		A2($elm$json$Json$Decode$decodeValue, $author$project$Main$initFlagsDecoder, flags));
	var incidentsRaw = _v0.incidentsRaw;
	var gunLawsRaw = _v0.gunLawsRaw;
	var stateIncidents = A2($author$project$Main$getStateData, gunLawsRaw, incidentsRaw);
	return _Utils_Tuple2(
		{
			currentPage: 0,
			gunIncidentsRaw: incidentsRaw,
			gunLawsRaw: gunLawsRaw,
			paginatedStateIncidents: A2($elm_community$list_extra$List$Extra$greedyGroupsOf, 11, stateIncidents),
...
var $author$project$Main$handlePageChange = F2(
	function (model, dir) {
			...
			_Utils_update(
				model,
				{
					currentPage: A3(
						...
						0,
						$elm$core$List$length(model.paginatedStateIncidents),
						newPage)
				}),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		var dir = msg.a;
		return A2($author$project$Main$handlePageChange, model, dir);
	});
...
var $author$project$Main$listFlatten = function (list) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (sub, result) {
				return _Utils_ap(result, sub);
			}),
		_List_Nil,
		list);
};
var $author$project$Main$combineAttrs = $author$project$Main$listFlatten;
...
var $author$project$Main$cell = F3(
	function (attrs, getter, val) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			$author$project$Main$combineAttrs(attrs),
...
var $author$project$UI$Colors$black = A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0);
...
var $author$project$UI$Helpers$border = F3(
	function (width, style, color) {
		return _List_fromArray(
			[
...
var $author$project$Main$solidBlackBorder = A3($author$project$UI$Helpers$border, 1, $mdgriffith$elm_ui$Element$Border$solid, $author$project$UI$Colors$black);
...
var $author$project$Main$tableHeader = function (header) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		$author$project$Main$combineAttrs(
			_List_fromArray(
				[
					A3($author$project$UI$Helpers$border, 1, $mdgriffith$elm_ui$Element$Border$solid, $author$project$UI$Colors$black),
					_List_fromArray(
					[
...
var $author$project$Main$dataTable = function (stateIncidents) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		A2(
			...
			$author$project$Main$combineAttrs(
				_List_fromArray(
					[
						$author$project$Main$solidBlackBorder,
						_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					...
					])),
			{
				columns: _List_fromArray(
					[
						{
						header: $author$project$Main$tableHeader('State'),
						view: A2(
						...
						{
						header: $author$project$Main$tableHeader('Gun Law Rating'),
						view: A2(
							$author$project$Main$cell,
							_List_fromArray(
								[
						...
						{
						header: $author$project$Main$tableHeader('Incidents'),
						view: A2(
							$author$project$Main$cell,
							_List_fromArray(
								[
				...
				data: A2($elm$core$Maybe$withDefault, _List_Nil, stateIncidents)
			}));
};
		...
		return A2(
				...
				]),
			{
				...
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$ChangePage(direction))
			});
	});
...
var $NoRedInk$elm_plot_19$Plot$dot = F3(
	function (view, x, y) {
		return {
...
var $NoRedInk$elm_plot_19$Plot$viewCircle = F2(
...
var $NoRedInk$elm_plot_19$Plot$circle = $NoRedInk$elm_plot_19$Plot$dot(
	A2($NoRedInk$elm_plot_19$Plot$viewCircle, 5, $NoRedInk$elm_plot_19$Internal$Colors$pinkStroke));
...
var $author$project$Main$customizedScatterPlot = function () {
	var horizontalAxis = $NoRedInk$elm_plot_19$Plot$customAxis(
		function (summary) {
			return {
				axisLine: $elm$core$Maybe$Just(
					$NoRedInk$elm_plot_19$Plot$simpleLine(summary)),
				...
				labels: A2(
					$elm$core$List$map,
					$NoRedInk$elm_plot_19$Plot$simpleLabel,
					A3($NoRedInk$elm_plot_19$Plot$interval, 0, 20, summary)),
				position: $NoRedInk$elm_plot_19$Plot$closestToZero,
				ticks: A2(
					$elm$core$List$map,
					$NoRedInk$elm_plot_19$Plot$simpleTick,
	...
	var defaultCustomization = $NoRedInk$elm_plot_19$Plot$defaultSeriesPlotCustomizations;
	...
	return _Utils_update(
		...
		{attributes: attributes, horizontalAxis: horizontalAxis});
}();
var $NoRedInk$elm_plot_19$Plot$None = {$: 'None'};
var $NoRedInk$elm_plot_19$Plot$dots = function (toDataPoints) {
	return {axis: $NoRedInk$elm_plot_19$Plot$normalAxis, interpolation: $NoRedInk$elm_plot_19$Plot$None, toDataPoints: toDataPoints};
};
...
var $author$project$Main$scatterChart = function (data) {
	var toDataPoints = function (state) {
		var rating = state.rating;
		var incidents = state.incidents;
		return A2($NoRedInk$elm_plot_19$Plot$circle, incidents, rating);
	};
	return A3(
		$NoRedInk$elm_plot_19$Plot$viewSeriesCustom,
		$author$project$Main$customizedScatterPlot,
		_List_fromArray(
			[
				$NoRedInk$elm_plot_19$Plot$dots(
				$elm$core$List$map(toDataPoints))
			]),
		data);
};
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$html(
						$author$project$Main$scatterChart(model.stateIncidents))),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							A2($elm_community$list_extra$List$Extra$getAt, model.currentPage, model.paginatedStateIncidents)),
							A2(
							...
							_List_fromArray(
								[
									A2($author$project$Main$pageButton, $author$project$Main$Prev, 'Prev'),
									A2($author$project$Main$pageButton, $author$project$Main$Next, 'Next')
								]))
						]))
				])));
};
